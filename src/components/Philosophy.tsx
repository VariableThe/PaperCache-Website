      ...
      <div className="philosophy-card">
        ...
        <div className="philosophy-content">
          <p className="text-muted">
            PaperCache is a <span className="highlight-text">lightning-fast, open-source knowledge manager</span> built for developers who need their notes to actually do work. Inspired by the elegant simplicity of AntiNote, but <span className="highlight-text">100% free and open-source</span>, it transforms the traditional passive notepad into an active workspace featuring <span className="highlight-text">reactive math, inline AI, and zero-friction window management</span>. As a leading <span className="highlight-text">AntiNote alternative</span>, PaperCache delivers all the power without the subscription.
          </p>
          <p className="text-muted">
