...
export default function Features() {
  ...
  const refFooter = useScrollFade();

  return (
    <section className="features-container">
      <div className="features-grid">
        <div className="feature-card fade-in-section" ref={ref1 as any}>
        ...
        <div className="feature-card fade-in-section" ref={ref2 as any}>
        ...
        <div className="feature-card fade-in-section" ref={ref3 as any}>
        ...
        <div className="feature-card fade-in-section" ref={ref4 as any}>
      ...
      <div className="features-footer fade-in-section" ref={refFooter as any} style={{ textAlign: 'center', marginTop: '60px' }}>
