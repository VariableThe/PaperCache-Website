      ...
      <div className="architecture-content">
        <div className="architecture-card">
          <p className="text-muted">
            PaperCache was originally built using Electron, but we recently migrated the entire backend to <span className="highlight-text">Rust and Tauri</span>. Why? Because a background knowledge manager shouldn't devour your RAM. This Electron to Tauri migration makes PaperCache one of the most performant <span className="highlight-text">Tauri productivity apps</span> available — offering dramatically better performance than traditional Electron-based note-taking tools.
          </p>
          <ul className="benefits-list text-muted">
            ...
            <li><strong>Instant Cold Starts:</strong> Lightning-fast execution, summoning PaperCache exactly when you need it.</li>
